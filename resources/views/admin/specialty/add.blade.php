                ...
                <div class="box-body">
                    <form action="{{ $action }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="cipher" class="form-control" @if(is_object($specialty)) value="{{ $specialty->cipher }}" @endif >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3">Наименование{{-- на русском--}}</label>
                            <div class="col-md-9">
                                <input type="text" name="name_ru" class="form-control" @if(is_object($specialty)) value="{{ $specialty->name_ru }}" @endif >
                            </div>
                        </div>
                        <div class="form-group row">
