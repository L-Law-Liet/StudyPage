            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{ $action }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3">Текст{{-- на русском--}}</label>
                            <div class="col-md-9">
                                <textarea name="content_ru" class="form-control">@if(is_object($requirement)) {{ $requirement->content_ru }} @endif</textarea>
                            </div>
                        </div>
                        {{--<div class="form-group row">
