                ...
                <div class="box-body">
                    <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control" @if(is_object($article)) value="{{ $article->title }}" @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3">Описание</label>
                            <div class="col-md-9">
                                <textarea name="description" class="form-control">@if(is_object($article)) {{ $article->description }} @endif</textarea>
                            </div>
                        </div>
                        <div class="clearfix">
