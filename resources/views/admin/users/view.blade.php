            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-striped table-view">
                        ...
                        <tr>
                            <th>Дата рождения</th>
                            <td>@if($user->birthDate){{date("d.m.Y", strtotime($user->birthDate))}}@elseНе указано @endif</td>
                        </tr>
                        <tr>
                            <th>Пол</th>
                        ...
                        <tr>
                            <th>Регион</th>
                            <td>@if ($user->region) {{\App\Models\City::find($user->region)->name_ru}} @else Не указано @endif</td>
                        </tr>
                        <tr>
