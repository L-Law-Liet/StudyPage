                ...
                <div class="box-body">
                    <form action="{{ $action }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="subdivision" class="form-control">@if(is_object($university)) {{ $university->subdivision }} @endif</textarea>
                            </div>
                        </div>
                        {{--<div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="city_id" class="form-control city">
                                    ...
                                    @foreach($cities as $k => $v)
                                        <option @if(is_object($university) && $university->city_id == $k) selected @endif value="{{ $k }}">{{ $v }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="phone" class="form-control" @if(is_object($university)) value="{{ $university->phone }}" @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3">Индекс</label>
                            <div class="col-md-9">
                                <input type="text" name="postcode" class="form-control" @if(is_object($university)) value="{{ $university->postcode }}" @endif>
                            </div>
                        </div>
                        <div class="form-group row">
