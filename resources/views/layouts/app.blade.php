        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="dialog-input-div border-bottom p-0 d-flex justify-content-between">
                    <input name="sum" oninput="minZero(event)" class="border-0 w-75" value="0" type="number" id="amountInput" title="Сумма пополнения"><div id="epayCurrency" class="w-25 dialog-valuta pt-2">&#8376;</div>
                </div>
